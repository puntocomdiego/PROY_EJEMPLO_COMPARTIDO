...
Partial Class FRM_NACHO
    ...
    Private Sub InitializeComponent()
        ...
        lblConsigna.Text = "TRABAJO PRACTICO - Conversor de Temperatura" & vbCrLf & vbCrLf &
            "El usuario ingresa una temperatura en grados Celsius. Al presionar el boton, convertirla a" & vbCrLf &
            "grados Fahrenheit y mostrar el resultado con el simbolo (ej: 25 C = 77 F)." & vbCrLf &
            "Formula: F = C * 9 / 5 + 32." & vbCrLf &
            "Validar que lo ingresado sea un numero. Mostrar el resultado en la etiqueta de abajo."
        ' 
        ' lblEntrada
        ' 
        ...
        lblEntrada.Text = "Grados Celsius:"
        ' 
        ' txtEntrada
        ' 
        ...
        Name = "FRM_NACHO"
        Text = "FRM_NACHO - Celsius a Fahrenheit"
        ResumeLayout(False)
        PerformLayout()
    End Sub
